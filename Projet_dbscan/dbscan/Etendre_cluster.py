...
# m :	Nombre minimum de points pour être un point cœur 
    ...
    while i < len(PtsVoisins): #On traite les voisins de P
      ...
      elif groupes[Pv_indice] == -1: #Si un point a ete considéré comme bruit dans main_dbscan mais qu’il est maintenant voisin d’un point cœur P alors on le reintègre dans le meme cluster que P
           groupes[Pv_indice] = k
